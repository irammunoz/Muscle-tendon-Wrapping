...
vw = VideoWriter('animation_NR_NW.avi');
vw.Quality = 100;
vw.FrameRate = 60;
open(vw);
...
xlabel('t [s]','Interpreter','latex','FontSize',12); ylabel('$l_{MT}$ [m]','Interpreter','latex','FontSize',12); %ylabel('$\lambda$','Interpreter','latex');
...
xlabel('t [s]','Interpreter','latex','FontSize',12); ylabel('$\dot{l}_{MT}$ [m/s]','Interpreter','latex','FontSize',12); %ylabel('$\lambda$','Interpreter','latex');
...
while nF(iter+1)>1e-10 && iter < 650
